...
import { badgeClass, btnClass, icon, safeUrl, optimizedImageUrl, escapeHtml } from "../ui.js";
    ...
    .map(
      ...
      <div class="list-row" data-product-row="${i === 0 ? "first" : ""}">
        ...
        <div class="list-row-main">
          ...
          <div class="text-muted" style="font-size:0.875rem">${escapeHtml(p.quantity)} ${t(unitLabelKey(p.unit))} — ${escapeHtml(p.price)} ${t("products.currency")}/${t(unitLabelKey(p.unit))}</div>
